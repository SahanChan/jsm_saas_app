...
const Profile = async () => {
    ...
    return <main className="min-lg:w-3/4">
        <section className="flex justbetween gap-4 max-sm:flex-col items-center">
        ...
        <Accordion type="multiple">
            ...
            <AccordionItem value="companions">
                <AccordionTrigger className="text-2xl font-bold">My
                    Companions {`(${companions?.length})`}</AccordionTrigger>
                <AccordionContent>
